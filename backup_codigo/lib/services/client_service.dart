...
class ClientService {
  ...
  Future<List<Client>> getClientsByVendor(String vendorId) async {
    try {
      print("DEBUG: Buscando clientes para el vendedor: $vendorId");
      ...
      print("DEBUG: Se encontraron ${snapshot.docs.length} clientes asignados al vendedor");

      // Si no hay clientes asignados, retornar todos los clientes como fallback
      if (snapshot.docs.isEmpty) {
        print("DEBUG: No hay clientes asignados, retornando todos los clientes como fallback");
        return getClients();
      }
      ...
      // Retornar clientes de respaldo en caso de error
      return _getFallbackClients();
    }
  }
