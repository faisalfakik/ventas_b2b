...
class _QuoteScreenState extends State<QuoteScreen> {
  ...
  double _calculateTax() {
    return _calculateSubtotal() * 0.16; // 16% IVA
  }
  ...
  Future<void> _generatePdf() async {
    if (_quoteItems.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Agrega productos a la cotización')),
      );
      return;
    }
                  ...
                  children: [
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(
                          'Folio: COT-${DateTime.now().millisecondsSinceEpoch.toString().substring(6)}',
                          style: const pw.TextStyle(
                            fontSize: 12,
                          ),
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Controles (Cantidad, Precio, Descuento)
                    Row(
                      children: [
                        // Control de cantidad
                        Expanded(
      ...
      // Panel inferior con totales y botón de generar PDF
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_isLoading ? 'Generando PDF...' : 'Generar PDF'),
              ),
            ),
          ],
        ),
